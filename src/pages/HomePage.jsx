    ...
    <div className="mx-4 mt-4">
      <main id="main-content" role="main" className="flex flex-col items-start justify-center w-full max-w-[1200px] mx-auto">
        <section className="content-section w-full mt-[110px] mb-14 flex flex-row md:flex-col mx-0 ">
          <figure className="flex flex-col justify-between items-start  mx-auto  md:flex-row md:justify-between sm:justify-center gap-2 md:gap-10">
            <img className="bg-black w-full  sm:max-w-[586px] h-auto rounded-xl" src="/images/main_banner.png" alt="안산전단지배포" />

            <figcaption className="flex flex-col justify-center items-start w-full  mt-6 sm:mt-0">
              <h2 className="section-title text-[24px] sm:text-[40px] font-semibold ">안산 전단지 배포</h2>
              <br />
              <p className=" text-subtitle text-sm sm:text-base font-normal leading-6">
                안산 전지역은 물론, <strong className="text-[#0000FE]">목감·배곧·시화·화성</strong>까지 지역 기반으로 전단지 디자인부터 인쇄, 배포까지 모든 과정을 직접 정성껏 진행하고 있습니다.
                <br />
                <br />
                성실히! 고객 한 분 한 분의 만족을 최우선으로 생각하며 <strong className="text-[#0000FE]">오랜 경험과 노하우</strong>를 바탕으로 정확하고 신속한 서비스를 제공합니다.
                <br />
                <br />
                믿고 맡길 수 있는 전단지 파트너, 안산전단지배포입니다.
              </p>
              {/* 숨겨진 input 필드 추가 */}
